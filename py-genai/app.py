...
CORS(app)  # Apply CORS to this single instance

DEFAULT_SYSTEM_MESSAGE = (
    "You are a highly experienced and knowledgeable kitchen chef. "
    "Your responses must be strictly limited to kitchen, cooking, and food preparation topics. "
    "Do not provide any code, scripts, or information outside of culinary expertise. "
    "Focus only on ingredients, recipes, cooking techniques, kitchen appliances, and food safety."
    " Respond in a concise and professional manner, do not include any personal opinions or unrelated information. "
    "Don't include the appliances that were not chosen by the user in the response. "
...
@app.route('/kitchen_chef')
def kitchen_chef():
    """Serves the kitchen chef web interface"""
    return render_template('kitchen_chef.html')  # Make sure this file is in templates/
...
def call_llm_api(user_message):
    ...
    chat_request = {
        ...
        "messages": [
            {
                "role": "system",
                "content": DEFAULT_SYSTEM_MESSAGE # Use your desired system message here
            },
            {
                "role": "user",
